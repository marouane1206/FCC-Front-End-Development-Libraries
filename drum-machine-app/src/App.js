...
class PadBank extends React.Component {
  render() {
    const padBank = this.props.power
      ? this.props.currentPadBank.map((pad, index, array) => (
          <DrumPad
            clip={array[index].url}
            clipId={array[index].id}
            key={array[index].id}
            keyCode={array[index].keyCode}
            keyTrigger={array[index].keyTrigger}
...
class App extends React.Component {
  ...
  selectBank() {
    if (this.state.power) {
      this.setState((prevState) => ({
        currentPadBank:
          prevState.currentPadBankId === "Heater Kit"
            ? pianoSounds
            : drumSounds,
        display:
          prevState.currentPadBankId === "Heater Kit"
  ...
  render() {
    const powerFloatStyle = this.state.power
      ? { float: "right" }
      : { float: "left" };

    const bankFloatStyle =
      this.state.currentPadBank === drumSounds
        ? { float: "left" }
        : { float: "right" };
        ...
        <div className="controls-container">
          <div className="control">
            ...
            <div className="select" onClick={this.powerControl}>
              <div className="inner" style={powerFloatStyle} />
            </div>
          </div>
          ...
          <div className="control">
            ...
            <div className="select" onClick={this.selectBank}>
              <div className="inner" style={bankFloatStyle} />
            </div>
          </div>
        </div>
      </div>
